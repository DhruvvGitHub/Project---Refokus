...
const Product = ({data, mover, count}) => {
  return (
    <div className='wrapper w-full h-72 px-5 text-white flex items-center'>
        <div onMouseEnter={() => {mover(count)}} className='content-div max-w-screen-lg mx-auto flex items-center justify-between'>
